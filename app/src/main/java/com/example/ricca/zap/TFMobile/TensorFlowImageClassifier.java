...
package com.example.ricca.zap.TFMobile;
...
public class TensorFlowImageClassifier implements Classifier {
    ...
    @Override
    public List<Recognition> recognizeImage(final Bitmap original_bitmap) {
        ...
        Bitmap bitmap=Bitmap.createScaledBitmap(original_bitmap,224,224,false);
